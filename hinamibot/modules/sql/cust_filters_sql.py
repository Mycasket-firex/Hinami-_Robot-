...
from hinamibot.modules.helper_funcs.msg_types import Types
...
class CustomFilters(BASE):
    ...
    def __init__(self, chat_id: int | str, keyword: str, reply: str,
                 reply_text: str, has_buttons: bool, has_media_spoiler: bool,
                 file_type: int, file_id: str):
