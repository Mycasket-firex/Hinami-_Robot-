...
import hinamibot.modules.sql.notes_sql as sql
from hinamibot import application, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from hinamibot.__main__ import DATA_IMPORT
from hinamibot.modules.helper_funcs.chat_status import check_admin
from hinamibot.modules.helper_funcs.alternate import typing_action

# from hinamibot.modules.rules import get_rules
import hinamibot.modules.sql.rules_sql as rulessql

# from hinamibot.modules.sql import warns_sql as warnssql
import hinamibot.modules.sql.blacklist_sql as blacklistsql
from hinamibot.modules.sql import disable_sql as disabledsql

# from hinamibot.modules.sql import cust_filters_sql as filtersql
# import hinamibot.modules.sql.welcome_sql as welcsql
...
async def export_data(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    with open("hinamibot{}.backup".format(chat_id), "w") as f:
