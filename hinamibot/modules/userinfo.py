...
from hinamibot.modules.sql.afk_sql import check_afk_status, is_afk
from hinamibot.modules.sql.approve_sql import is_approved
from hinamibot.modules.users import get_user_id
...
async def info(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    reply = await message.reply_text("<code>Getting Information...</code>",
                                     parse_mode=ParseMode.HTML)
