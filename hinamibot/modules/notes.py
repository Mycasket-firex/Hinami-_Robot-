...
from hinamibot import LOGGER, JOIN_LOGGER, SUPPORT_CHAT, application, DRAGONS
...
from hinamibot.modules.helper_funcs.chat_status import check_admin, connection_status
from hinamibot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from hinamibot.modules.helper_funcs.msg_types import get_note_type
    ...
    if failures:
        with BytesIO(str.encode("\n".join(failures))) as output:
            ...
            await application.bot.send_document(
                ...
                message_thread_id=message.message_thread_id
                if message.chat.is_forum else None)
