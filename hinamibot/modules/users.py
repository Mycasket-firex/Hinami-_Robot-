...
import hinamibot.modules.sql.users_sql as sql
from hinamibot import DEV_USERS, LOGGER, OWNER_ID, application
from hinamibot.modules.helper_funcs.chat_status import check_admin
from hinamibot.modules.sql.users_sql import get_all_users
