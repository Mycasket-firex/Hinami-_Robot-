...
from hinamibot.modules import ALL_MODULES
from hinamibot.modules.helper_funcs.chat_status import is_user_admin
from hinamibot.modules.helper_funcs.misc import paginate_modules
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @lostdir69 \
 Supporting isn't always financial! \
 Those who cannot provide monetary support are welcome to help us develop the bot at @darkness_devs."""
...
async def help_button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    HELP_STRINGS = """
    Hey there!.
    My Name is {}, from Tokyo ghoul. Take me as your group's darling to have fun with me. \
    I can help you with the following commands.
